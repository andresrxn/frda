...
if($datos["nombre"] == 1 && $datos["email"] == 1 && $datos["msg"] == 1 && $datos["terms"] == 1){
...
if($enviar["datos"] == 1){
    ...
    $body = "<b>Mensaje:</b> <br><br>" . $msg  . "<br><br><br><br> <b>De parte de:</b><br>  " . $name .  "<br><br> <b>Correo Electrónico:</b><br>  " . $email . "<br> <hr><br> <b>Enviado desde el Sitio Web de Redes de Ayuda.</b>";
    try {
        ...
        document.querySelector('.email-sent p').innerText = 'Gracias $palabras[0] por hacernos saber tus preguntas, un miembro de nuestro equipo se comunicará contigo con las respuestas correspondientes.';
        ...
        $sqlInsertar = "INSERT INTO contacto(nombre, correo, asunto, fecha, fecha_orden, mensaje) VALUES ('$name', '$email', '$subject', '$date', NOW(), '$msg')";
